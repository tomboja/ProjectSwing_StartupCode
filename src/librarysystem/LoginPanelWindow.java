...
public class LoginPanelWindow extends JFrame implements MessageableWindow, LibWindow {
	public static final LibWindow INSTANCE = new LoginPanelWindow();
	...
	private void addLoginButtonListener(JButton butn) {
		butn.addActionListener(evt -> {
			try {
				RuleSet rules=RuleSetFactory.getRuleSet(LoginPanelWindow.this);
				rules.applyRules(LoginPanelWindow.this);
			} catch (RuleException e){
				JOptionPane.showMessageDialog(LoginPanelWindow.this, e.getMessage());
			}
